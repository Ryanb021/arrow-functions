...
//  'this' is the object and the Student is when joe.scope() was invoked.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  'this' makes reference to the window that is used in the joe.scopeArrow prototype function
// 3. Explain why "this" is different when an arrow function is used.
//  'this' is different when an arrow function is used because the keyword 'this' will not bind the object or function that called the function. it will always refer to the object that defined the arrow function.
